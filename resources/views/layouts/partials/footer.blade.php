        ...
        <div class="col-md-3 col-sm-6 col-xs-12 width-50 width-set-50">
            <div class="footer-details">
                ...
                <ul class="list-unstyled footer-links">
                    ...
                    <li class="{{ ($title === "rooms") ? 'active' : ''}}"><a href="/rooms">Rooms</a></li>
                    <li class="{{ ($title === "gallery") ? 'active' : ''}}"><a href="/gallery">Gallery</a></li>
                    <li class="{{ ($title === "dinning") ? 'active' : ''}}"><a href="/dinning">Dinning</a></li>
                    <li class="{{ ($title === "news") ? 'active' : ''}}"><a href="/news">News</a></li>
